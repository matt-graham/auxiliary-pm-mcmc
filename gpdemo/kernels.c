...
static const char __pyx_k_gpdemo_kernels[] = "gpdemo.kernels";
...
static const char __pyx_k_Cython_implementations_of_Gauss[] = "\nCython implementations of Gaussian process covariance kernel functions\n";
static const char __pyx_k_home_matt_Projects_auxiliary_pm[] = "/home/matt/Projects/auxiliary-pm-mcmc/gpdemo/kernels.pyx";
...
static const char __pyx_k_diagonal_squared_exponential_ker[] = "diagonal_squared_exponential_kernel";
static const char __pyx_k_got_differing_extents_in_dimensi[] = "got differing extents in dimension %d (got %d and %d)";
static const char __pyx_k_isotropic_squared_exponential_ke[] = "isotropic_squared_exponential_kernel";
...
static PyObject *__pyx_kp_s_home_matt_Projects_auxiliary_pm;
...
static PyObject *__pyx_pw_6gpdemo_7kernels_1isotropic_squared_exponential_kernel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("isotropic_squared_exponential_kernel (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("isotropic_squared_exponential_kernel", 0, 3, 4, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_theta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("isotropic_squared_exponential_kernel", 0, 3, 4, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        case  3:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "isotropic_squared_exponential_kernel") < 0)) __PYX_ERR(0, 8, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_K = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_K.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_X = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_X.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_theta = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2]); if (unlikely(!__pyx_v_theta.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    if (values[3]) {
  ...
  __Pyx_RaiseArgtupleInvalid("isotropic_squared_exponential_kernel", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 8, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
        ...
        } else if (unlikely(__pyx_t_15 >= __pyx_v_X.shape[1])) __pyx_t_11 = 1;
        if (unlikely(__pyx_t_11 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_11);
        ...
        } else if (unlikely(__pyx_t_16 >= __pyx_v_X.shape[0])) __pyx_t_11 = 0;
        if (__pyx_t_17 < 0) {
          __pyx_t_17 += __pyx_v_X.shape[1];
          if (unlikely(__pyx_t_17 < 0)) __pyx_t_11 = 1;
        } else if (unlikely(__pyx_t_17 >= __pyx_v_X.shape[1])) __pyx_t_11 = 1;
        if (unlikely(__pyx_t_11 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_11);
          __PYX_ERR(0, 43, __pyx_L1_error)
        }
        ...
        } else if (unlikely(__pyx_t_18 >= __pyx_v_K.shape[0])) __pyx_t_11 = 0;
        if (__pyx_t_19 < 0) {
          __pyx_t_19 += __pyx_v_K.shape[1];
          if (unlikely(__pyx_t_19 < 0)) __pyx_t_11 = 1;
        } else if (unlikely(__pyx_t_19 >= __pyx_v_K.shape[1])) __pyx_t_11 = 1;
        if (unlikely(__pyx_t_11 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_11);
          __PYX_ERR(0, 43, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_K.data + __pyx_t_18 * __pyx_v_K.strides[0]) ) + __pyx_t_19 * __pyx_v_K.strides[1]) )) += pow(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_14 * __pyx_v_X.strides[0]) ) + __pyx_t_15 * __pyx_v_X.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_16 * __pyx_v_X.strides[0]) ) + __pyx_t_17 * __pyx_v_X.strides[1]) )))), 2.0);
      }
 ...
 */
      ...
      __pyx_t_11 = -1;
      if (__pyx_t_20 < 0) {
        __pyx_t_20 += __pyx_v_K.shape[0];
        if (unlikely(__pyx_t_20 < 0)) __pyx_t_11 = 0;
      } else if (unlikely(__pyx_t_20 >= __pyx_v_K.shape[0])) __pyx_t_11 = 0;
      if (__pyx_t_21 < 0) {
        __pyx_t_21 += __pyx_v_K.shape[1];
        if (unlikely(__pyx_t_21 < 0)) __pyx_t_11 = 1;
      } else if (unlikely(__pyx_t_21 >= __pyx_v_K.shape[1])) __pyx_t_11 = 1;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
        __PYX_ERR(0, 44, __pyx_L1_error)
      }
      __pyx_t_22 = (-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_K.data + __pyx_t_20 * __pyx_v_K.strides[0]) ) + __pyx_t_21 * __pyx_v_K.strides[1]) ))));
      ...
      } else if (unlikely(__pyx_t_24 >= __pyx_v_K.shape[0])) __pyx_t_11 = 0;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_K.shape[1];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_11 = 1;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_K.shape[1])) __pyx_t_11 = 1;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
        __PYX_ERR(0, 44, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_K.data + __pyx_t_24 * __pyx_v_K.strides[0]) ) + __pyx_t_25 * __pyx_v_K.strides[1]) )) = (__pyx_v_sigma * exp((__pyx_t_22 / __pyx_t_23)));
 ...
 */
      ...
      } else if (unlikely(__pyx_t_26 >= __pyx_v_K.shape[0])) __pyx_t_11 = 0;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_v_K.shape[1];
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_11 = 1;
      } else if (unlikely(__pyx_t_27 >= __pyx_v_K.shape[1])) __pyx_t_11 = 1;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
      ...
      } else if (unlikely(__pyx_t_28 >= __pyx_v_K.shape[0])) __pyx_t_11 = 0;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_v_K.shape[1];
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_11 = 1;
      } else if (unlikely(__pyx_t_29 >= __pyx_v_K.shape[1])) __pyx_t_11 = 1;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
        __PYX_ERR(0, 45, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_K.data + __pyx_t_28 * __pyx_v_K.strides[0]) ) + __pyx_t_29 * __pyx_v_K.strides[1]) )) = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_K.data + __pyx_t_26 * __pyx_v_K.strides[0]) ) + __pyx_t_27 * __pyx_v_K.strides[1]) )));
    }
  }
...
static PyObject *__pyx_pw_6gpdemo_7kernels_3diagonal_squared_exponential_kernel(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("diagonal_squared_exponential_kernel (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_X)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("diagonal_squared_exponential_kernel", 0, 3, 4, 1); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_theta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("diagonal_squared_exponential_kernel", 0, 3, 4, 2); __PYX_ERR(0, 48, __pyx_L3_error)
        }
        case  3:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_epsilon);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "diagonal_squared_exponential_kernel") < 0)) __PYX_ERR(0, 48, __pyx_L3_error)
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  4: values[3] = PyTuple_GET_ITEM(__pyx_args, 3);
    ...
    __pyx_v_K = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_K.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_X = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_X.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_theta = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[2]); if (unlikely(!__pyx_v_theta.memview)) __PYX_ERR(0, 49, __pyx_L3_error)
    if (values[3]) {
      __pyx_v_epsilon = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_epsilon == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L3_error)
    } else {
      __pyx_v_epsilon = ((double)1e-8);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("diagonal_squared_exponential_kernel", 0, 3, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 48, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
        ...
        } else if (unlikely(__pyx_t_15 >= __pyx_v_X.shape[0])) __pyx_t_14 = 0;
        if (__pyx_t_16 < 0) {
          __pyx_t_16 += __pyx_v_X.shape[1];
          if (unlikely(__pyx_t_16 < 0)) __pyx_t_14 = 1;
        } else if (unlikely(__pyx_t_16 >= __pyx_v_X.shape[1])) __pyx_t_14 = 1;
        if (unlikely(__pyx_t_14 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_14);
          __PYX_ERR(0, 84, __pyx_L1_error)
        }
        __pyx_t_17 = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_12 * __pyx_v_X.strides[0]) ) + __pyx_t_13 * __pyx_v_X.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_X.data + __pyx_t_15 * __pyx_v_X.strides[0]) ) + __pyx_t_16 * __pyx_v_X.strides[1]) ))));
        __pyx_t_18 = (__pyx_v_k + 1);
        __pyx_t_14 = -1;
        if (__pyx_t_18 < 0) {
          __pyx_t_18 += __pyx_v_theta.shape[0];
          if (unlikely(__pyx_t_18 < 0)) __pyx_t_14 = 0;
        } else if (unlikely(__pyx_t_18 >= __pyx_v_theta.shape[0])) __pyx_t_14 = 0;
        if (unlikely(__pyx_t_14 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_14);
          __PYX_ERR(0, 84, __pyx_L1_error)
        }
        ...
        } else if (unlikely(__pyx_t_20 >= __pyx_v_K.shape[0])) __pyx_t_14 = 0;
        if (__pyx_t_21 < 0) {
          __pyx_t_21 += __pyx_v_K.shape[1];
          if (unlikely(__pyx_t_21 < 0)) __pyx_t_14 = 1;
        } else if (unlikely(__pyx_t_21 >= __pyx_v_K.shape[1])) __pyx_t_14 = 1;
        if (unlikely(__pyx_t_14 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_14);
          __PYX_ERR(0, 84, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_K.data + __pyx_t_20 * __pyx_v_K.strides[0]) ) + __pyx_t_21 * __pyx_v_K.strides[1]) )) += pow((__pyx_t_17 / __pyx_t_19), 2.0);
      }
 ...
 */
      ...
      } else if (unlikely(__pyx_t_22 >= __pyx_v_K.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_v_K.shape[1];
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_23 >= __pyx_v_K.shape[1])) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
      ...
      } else if (unlikely(__pyx_t_24 >= __pyx_v_K.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_K.shape[1];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_K.shape[1])) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 85, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_K.data + __pyx_t_24 * __pyx_v_K.strides[0]) ) + __pyx_t_25 * __pyx_v_K.strides[1]) )) = (__pyx_v_sigma * exp(((-(*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_K.data + __pyx_t_22 * __pyx_v_K.strides[0]) ) + __pyx_t_23 * __pyx_v_K.strides[1]) )))) / 2.)));
 ...
 */
      ...
      } else if (unlikely(__pyx_t_26 >= __pyx_v_K.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_v_K.shape[1];
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_27 >= __pyx_v_K.shape[1])) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
      ...
      } else if (unlikely(__pyx_t_28 >= __pyx_v_K.shape[0])) __pyx_t_10 = 0;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_v_K.shape[1];
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_29 >= __pyx_v_K.shape[1])) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 86, __pyx_L1_error)
      }
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_home_matt_Projects_auxiliary_pm, __pyx_k_home_matt_Projects_auxiliary_pm, sizeof(__pyx_k_home_matt_Projects_auxiliary_pm), 0, 0, 1, 0},
 ...
 *     """ Calculates covariance matrix for isotropic squared exponential kernel.
 */
  __pyx_tuple__14 = PyTuple_Pack(9, __pyx_n_s_K, __pyx_n_s_X, __pyx_n_s_theta, __pyx_n_s_epsilon, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_sigma, __pyx_n_s_tau, __pyx_n_s_k); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(4, 0, 9, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_matt_Projects_auxiliary_pm, __pyx_n_s_isotropic_squared_exponential_ke, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 8, __pyx_L1_error)
 ...
 *     """ Calculates covariance matrix for diagonal squared exponential kernel.
 */
  __pyx_tuple__16 = PyTuple_Pack(8, __pyx_n_s_K, __pyx_n_s_X, __pyx_n_s_theta, __pyx_n_s_epsilon, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_sigma); if (unlikely(!__pyx_tuple__16)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__16);
  __Pyx_GIVEREF(__pyx_tuple__16);
  __pyx_codeobj__17 = (PyObject*)__Pyx_PyCode_New(4, 0, 8, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_matt_Projects_auxiliary_pm, __pyx_n_s_diagonal_squared_exponential_ker, 48, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__17)) __PYX_ERR(0, 48, __pyx_L1_error)
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "gpdemo.kernels")) {
      if (unlikely(PyDict_SetItemString(modules, "gpdemo.kernels", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     """ Calculates covariance matrix for isotropic squared exponential kernel.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6gpdemo_7kernels_1isotropic_squared_exponential_kernel, NULL, __pyx_n_s_gpdemo_kernels); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_isotropic_squared_exponential_ke, __pyx_t_1) < 0) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     """ Calculates covariance matrix for diagonal squared exponential kernel.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6gpdemo_7kernels_3diagonal_squared_exponential_kernel, NULL, __pyx_n_s_gpdemo_kernels); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_diagonal_squared_exponential_ker, __pyx_t_1) < 0) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
